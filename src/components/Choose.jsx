    ...
    <div className="bg-choose1 relative w-full h-full bg-center">
      ...
      >
        ...
        <h2 className="text-[28px] text-black mt-10 font-bold mb-10">
          Bạn đang là thành viên của 3 gia đình, hãy chọn 1 nhé!
        </h2>
        <Select
          styles={customStyles}
        ...
        />
        <h2
          className="text-[28px] text-black mt-10 font-bold mb-10"
          onClick={() => navigate("/choose-noFamily")}
        >
          Nếu bạn đang chưa có gia đình, hãy nhấn vào đây để tạo hoặc tham gia
          ngay!
        </h2>
